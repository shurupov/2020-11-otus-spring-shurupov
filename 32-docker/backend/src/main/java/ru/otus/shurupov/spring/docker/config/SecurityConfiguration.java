package ru.otus.shurupov.spring.docker.config;
...
import ru.otus.shurupov.spring.docker.config.security.SpaAuthenticationSuccessHandler;
import ru.otus.shurupov.spring.docker.config.security.SpaLoginResponseGeneratingFilter;

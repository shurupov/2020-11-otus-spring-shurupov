package ru.otus.shurupov.spring.docker.controller;

import lombok.RequiredArgsConstructor;
import org.springframework.web.bind.annotation.*;
import ru.otus.shurupov.spring.docker.domain.Book;
import ru.otus.shurupov.spring.docker.domain.Genre;
import ru.otus.shurupov.spring.docker.domain.dto.BookResponse;
import ru.otus.shurupov.spring.docker.domain.dto.BookRequest;
import ru.otus.shurupov.spring.docker.domain.dto.PoorBookResponse;
import ru.otus.shurupov.spring.docker.service.BookService;

package ru.otus.shurupov.spring.hystrix.config;
...
import ru.otus.shurupov.spring.hystrix.config.security.SpaAuthenticationSuccessHandler;
import ru.otus.shurupov.spring.hystrix.config.security.SpaLoginResponseGeneratingFilter;
